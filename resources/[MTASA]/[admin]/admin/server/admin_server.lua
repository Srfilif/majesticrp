...
function notifyPlayerLoggedIn(player)
    local StaffNameP = getPlayerName(player)
setTimer(function()

    outputChatBox("#ffFFff* Tienes permisos especiales, has entrado como #ff3333Administrador#ffFFff.", player, 255, 255, 255, true)
    outputChatBox("#ffFFff", player, 255, 255, 255, true)

end,2000,1)
    -- outputChatBox("#90f542[Admin] #ffFFffRecuerda que puedes usar #f54242P #ffFFffpara abrir el panel de administracion. ", player ,255,255,255,true)
