...
if not exports.GTIemployment:getPlayerJob(true) == "Granjero" then return end
...
function plowEntry( hitElement, matchingDimension)
    if hitElement == localPlayer then
	    ...
	    if currentSeeds <= 0 then
		exports.GTIhud:dm("Estas sin semillas, Ve a la tienda a comprar mas", 255, 0, 0)
		return
	    end
...
function onBalePickup(hitPlayer, matchingDimension)
    if hitPlayer == localPlayer then
        if exports.GTIemployment:getPlayerJob(true) == "Granjero" then
            if not isPedInVehicle(localPlayer) then
                ...
                if ( type ( data ) == "table" ) then
                    ...
                    elseif (totalPickedUp == plantsCount) then
                        ...
                        totalPickedUp = 0
                        plantsCount = 0
                        exports.GTIhud:dm("Tienes que recojer "..morePickUp.." para obtener tu proximo pago", 255, 0, 0)
                    end
                end
            end
        end
