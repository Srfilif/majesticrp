...
addEventHandler("GTIPizzaDelivery.getpaid", root, function(dist_)
	...
	local payOffset = exports.GTIemployment:getPlayerJobPayment(client, "Pizzero")
	...
	exports.GTIemployment:modifyPlayerJobProgress(client, "Pizzero", 1)
	exports.GTIemployment:modifyPlayerEmploymentExp(client, Exp, "Pizzero")
	exports.GTIemployment:givePlayerJobMoney(client, "Pizzero", pay)
end)

function PizzaboyEnter ( thePlayer, seat, jacked )
	if isElement(source) and ( getElementModel ( source ) == 448 ) and (exports.GTIrentals:getPlayerRentalVehicle(thePlayer) == source) and (seat == 0) and (exports.GTIemployment:getPlayerJob(thePlayer,true) == "Pizzero") then 
...
addEventHandler("GTIPizzaDelivery.anim", root, 
	function(anim,box)
		if box == 0 then
