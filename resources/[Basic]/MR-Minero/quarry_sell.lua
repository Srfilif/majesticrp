addEventHandler("onClientResourceStart", resourceRoot,
    function()
        ...
        Window = guiCreateWindow(X, Y, Width, Height, "POPLife ~ Venta de Minerales", false)
        guiWindowSetSizable(Window, false)
        guiSetAlpha(Window, 0.98)

        SellButton = guiCreateButton(287, 208, 95, 33, "Vender", false, Window)
        guiSetFont(SellButton, "default-bold-small") 
        calcButton = guiCreateButton(187, 208, 95, 33, "Estimar", false, Window)
        guiSetFont(calcButton, "default-bold-small")
        ImageCopper = guiCreateStaticImage(16, 44, 58, 65, "misc/element.png", false, Window)
        ...
        ImageSilver = guiCreateStaticImage(156, 44, 58, 65, "misc/element2.png", false, Window)
        ...
        ImageMagnesium = guiCreateStaticImage(288, 45, 58, 65, "misc/element3.png", false, Window)
        ...
        ImageIron = guiCreateStaticImage(421, 45, 58, 65, "misc/element4.png", false, Window)
        ...
        ImageGold = guiCreateStaticImage(546, 45, 57, 65, "misc/element5.png", false, Window)
...
function showTradingGUI()
	...
	showCursor(true)
	local gram = getGrams()
	guiSetText(TotalGrams,"Gramos totales de minerales: "..gram.." G")
end
...
function handleBtns()
	...
	elseif ( source == calcButton ) then
		...
		exports.GTIhud:drawProgressBar("MiningPro", "Estimando...", 255, 200, 0, 6700)
		calculated = true
	elseif ( source == SellButton) then
		if not calculated or not PayTotal or isTimer(payTimer) then exports.GTIhud:dm("Primero tienes que estimar los minerales antes de venderlos", 255, 0, 0) return end
		local gram = getGrams()
		...
		exports.GTIhud:drawProgressBar("MiningPro", "Vendiendo...", 255, 200, 0, secs)
	end
end
...
addEventHandler("GTImining.calculate", root, function(poffset)
	...
	guiSetText(Total, "Total en $: "..GrandTotal.."$")
end)