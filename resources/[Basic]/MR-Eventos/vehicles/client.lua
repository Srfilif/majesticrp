...
function createGUI()
        vehWindow = guiCreateWindow(350, 260, 292, 174, "Creacion de Vehiculos", false)
...
function openGUI()
    if (exports.CSTteams:isPlayerInTeams(source, "Staff")) then
...
function placeCar()
    ...
    if (getElementType(object) == "vehicle" and dim ~= 0) then
        ...
        triggerServerEvent("CSTevents.spawnCar", localPlayer, id, x, y, z, rx, ry, rz, dim, int, {r1, g1, b1, r2, g2, b2, r3, g3, b3, r4, g4, b4})
    end
