...
function getPosition(source)
	...
	source:outputChat("X, Y, Z: "..x..", "..y..", "..z.."", 255, 200, 0)
	source:outputChat("ROT: "..rx..", "..ry..", "..rz.."", 255, 200, 0)
	source:outputChat("INT, DIM: "..int..", "..dim.."", 255, 200, 0)
end
addCommandHandler("xx", getPosition)