...
-- Crear puntos cardinales en la interfaz del juego

-- Archivo: resources/client-side/cardinal_points_client.lua

-- Función para recibir puntos cardinales del servidor
-- Crear blips de puntos cardinales en el radar del jugador
