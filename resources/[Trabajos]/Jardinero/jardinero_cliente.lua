...
function startRutaJardinero(tip, ruta)
	...
	if localPlayer:getData("Roleplay:trabajo") == "Jardinero" then
...
function onJardineroHitMarker( hitElement )
	if isElement(hitElement) and hitElement:getType() == "player" and hitElement == localPlayer then
		if hitElement:isInVehicle() then
			if hitElement:getData("Roleplay:trabajo") == "Jardinero" and ValoresTrabajo[hitElement][3] == true then
				local veh = hitElement:getOccupiedVehicle()
				local seat = hitElement:getOccupiedVehicleSeat()
				if veh:getModel() == 531 and seat == 0 and veh:getData("VehiculoPublico") == "Jardinero" then
	...
	function(thePlayer, seat)
        ...
        if thePlayer == getLocalPlayer() then
        	...
        	if seat == 0 then
        		...
        		if source:getModel() == 531 and source:getData("VehiculoPublico") == "Jardinero" then

        			if thePlayer:getData("Roleplay:trabajo") == "Jardinero" then
