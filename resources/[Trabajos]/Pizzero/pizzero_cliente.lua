...
function linea3d(i,player)
	xx,yy,zz = i[1], i[2], i[3] 
		...
		if hitElement:getData("Roleplay:trabajo") == "Pizzero" and ValoresTrabajo[hitElement][3] == true then
			...
			if hitElement:isInVehicle() then
				...
				if ValoresTrabajo[localPlayer][4] >= 1 then
					...
					outputChatBox("¡Ya no tienes suficiente pedidos, ve por mas!",255,100,100,true)
...
addEventHandler("onClientRender", getRootElement(), function()
	...
	local playerX1, playerY1, playerZ1 = 2110.8359375, -1787.658203125, 13.560846328735
	...
	if sx1 and sy1 then
		...
		if distance < 20 then
			...
			dxDrawBorderedText3 ( "Preciona #FF9600F #FFFFFFpara respawnear\nuna moto", sx1, sy1, sx1, sy1 , tocolor (255, 255, 255, 255 ),1, "default-bold","center", "center" ) 

		end

	end

	local playerX12, playerY12, playerZ12 = 2117.2470703125, -1787.611328125, 13.560846328735
	...
	if sx2 and sy2 then
		...
		if distance < 20 then
			...
			dxDrawBorderedText3 ( "Preciona #FF9600F #FFFFFFpara eliminar\ntu moto", sx2, sy2, sx2, sy2 , tocolor (255, 255, 255, 255 ),1, "default-bold","center", "center" ) 
