		...
		if permisos[getACLFromPlayer(player)] == true then
			...
			if faction ~= 'all' then
				...
				if tablet then
					...
					if isElement(vehicle.Veh) then
						...
						if isVehicleEmpty( vehicle.Veh ) then
                            ...
                            outputChatBox("El Vehiculo Faccionario #DDFF00"..faction:upper().." - "..placa.." #ffFFffha sido respawneado",player,255,255,255,true)
                    ...
                    outputChatBox("Syntax: /respawnvehpub all",player,255,255,255,true)
                    outputChatBox("Syntax: /respawnvehpub <clave> <id>",player,255,255,255,true)
                    outputChatBox("Claves: Mary, ADAM, Louis, LINCON, TAC, TORH, DAVID, DIC, BUS",player,255,255,255,true)
				end
				...
				for _,dd in pairs(Vehicles_s.vehicles) do
                    ...
                    outputChatBox("#FFFFFFTodos los #DDFF00vehículos públicos #FFFFFFhan sido respawneados.",player,255,255,255,true)
		...
		if permisos[getACLFromPlayer(player)] == true then
			...
			for _,dd in pairs(Vehicles_s.vehicles) do
				...
				for index,data in pairs(dd) do
                    ...
                    outputChatBox("#FFFFFFTodos los #DDFF00vehículos públicos #FFFFFFse les ha llenado la gasolina.",player,255,255,255,true)
