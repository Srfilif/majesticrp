...
addEventHandler( "onClientRender", getRootElement(),
	function()
		...
		for i=8,1,-1 do
			...
			if v then
				dxDrawBorderedText(v[1], sW*10, sH*381-Y, sW*192, sH*399, tocolor(255, 255, 255, v[2]), 1, "default-bold", "left", "top", false, false, true, true, false)	
				v[2] = v[2] - 0.50
				Y = Y + dxGetFontHeight( 1, "default-bold" )
				if v[2] <= 0 then
