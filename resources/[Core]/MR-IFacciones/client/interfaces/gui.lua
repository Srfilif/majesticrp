...
grouppanel = guiCreateWindow(482, 213, 421, 332, "Sistema de grupos", false)
guiWindowSetSizable(grouppanel, false)
 guiSetAlpha(grouppanel, 0.90)
        F_PreGui_Label = guiCreateLabel(0, 197, 421, 66, "Una vez elijas un tipo de Faccion ilegal no podras cambiarlo. Tampoco podras cambiar el nombre\nni su abreviacion.\n\nDependiendo de que elijas podras tener distintas posibilidades. Es posible que mas tipos de\nFaccion ilegal se agregen en proximas actualizaciones.", false, grouppanel)
        guiSetFont(F_PreGui_Label, "default-small")
        guiLabelSetHorizontalAlign(F_PreGui_Label, "center", false)

editcrgp = guiCreateEdit(21, 51, 372, 19, "", false, grouppanel)

creategpb = guiCreateButton(119, 298, 180, 21, "Crear", false, grouppanel)
guiSetFont(creategpb, "default-bold-small")
guiSetProperty(creategpb, "NormalTextColour", "FFAAAAAA")
invt = guiCreateButton(326, 298, 85, 21, "Invitaciones", false, grouppanel)
guiSetProperty(invt, "NormalTextColour", "FFFFFEFE")

        grouplistb = guiCreateButton(154, 267, 109, 21, "Grupos Creados", false, grouppanel)   
guiSetProperty(grouplistb, "NormalTextColour", "FFFFFEFE") 
       guiSetVisible(grouplistb,false)
        label1 = guiCreateLabel(0, 24, 421, 23, "Nombre", false, grouppanel)
        guiSetFont(label1, "default-bold-small")
        guiLabelSetHorizontalAlign(label1, "center", false)
        grouplabelc12 = guiCreateLabel(0, 76, 421, 23, "Tipo", false, grouppanel)
        
guiSetFont(grouplabelc12, "default-bold-small")
        guiLabelSetHorizontalAlign(grouplabelc12, "center", false)

  comoboxtypegroipc = guiCreateComboBox(249, 105, 157, 82, "Organizacion Criminal", false, grouppanel)
        guiComboBoxAddItem(comoboxtypegroipc, "Pandilla")
        guiComboBoxAddItem(comoboxtypegroipc, "Organizacion Criminal")
        creargruplael2 = guiCreateLabel(132, 99, 117, 88, "25.000$ dolares\nNivel 10", false, grouppanel)
        guiSetFont(creargruplael2, "default-bold-small")
        guiLabelSetVerticalAlign(creargruplael2, "center")    

        creargruplael23 = guiCreateLabel(0, 99, 128, 88, "Precio por  creacion:\nNivel necesario:", false, grouppanel)
        guiSetFont(creargruplael23, "default-bold-small")
        guiLabelSetColor(creargruplael23, 255, 185, 35)
        guiLabelSetHorizontalAlign(creargruplael23, "right", false)
        guiLabelSetVerticalAlign(creargruplael23, "center")

-- gpmoney = guiCreateButton(12, 116, 110, 22, "Abandonar grupo", false, grouppanel)
-- guiSetProperty(gpmoney, "NormalTextColour", "FFFFFEFE")
newclose = guiCreateButton(10, 301, 71, 18, "Cerrar", false, grouppanel)
