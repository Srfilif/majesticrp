...
-- Labels (Static)
employment.label[1] = guiCreateLabel(13, 30, 48, 15, "Nombre:", false, employment.window[1])
guiSetFont(employment.label[1], "default-bold-small")
guiLabelSetHorizontalAlign(employment.label[1], "right", false)
employment.label[2] = guiCreateLabel(221, 55, 58, 15, "Rango:", false, employment.window[1])
...
employment.label[7] = guiCreateLabel(221, 30, 58, 15, "Fecha:", false, employment.window[1])
...
employment.label[11] = guiCreateLabel(13, 55, 48, 15, "Trabajo:", false, employment.window[1])
...
employment.label[15] = guiCreateLabel(231, 102, 55, 15, "Uniforme:", false, employment.window[1])
...
-- Comboboxes
employment.combobox[1] = guiCreateComboBox(62, 99, 150, 25, "Elejir Division...", false, employment.window[1])
employment.combobox[2] = guiCreateComboBox(285, 99, 150, 25, "Elejir Uniforme...", false, employment.window[1])
-- Gridlist
...
-- Buttons
employment.button[1] = guiCreateButton(84, 337, 140, 25, "Tomar Trabajo", false, employment.window[1])
guiSetFont(employment.button[1], "default-bold-small")
employment.button[2] = guiCreateButton(230, 337, 140, 25, "Cerrar", false, employment.window[1])
