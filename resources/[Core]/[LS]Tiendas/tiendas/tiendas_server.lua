buysshop = {
	["24/7"] = {
	{-27.940196990967, -89.615165710449, 1003.546875, int= 18, dim = 0, items={"Telefono", "Agenda", "Lata de Spray", "Caja de Cigarros", "Encendedor", "Camara", "Cerveza", "Martillo", "Agua"}},
	{-27.940196990967, -89.615165710449, 1003.546875, int= 18, dim = 1, items={"Telefono", "Agenda", "Lata de Spray", "Caja de Cigarros", "Encendedor", "Camara", "Cerveza", "Martillo", "Agua"}},
	{-27.940196990967, -89.615165710449, 1003.546875, int= 18, dim = 3, items={"Telefono", "Agenda", "Lata de Spray", "Caja de Cigarros", "Encendedor", "Camara", "Cerveza", "Martillo", "Agua"}},
	{-23.242370605469, -55.641002655029, 1003.546875, int= 6, dim = 2, items={"Telefono", "Agenda", "Lata de Spray", "Caja de Cigarros", "Encendedor", "Camara", "Cerveza", "Martillo", "Agua"}},
	{-23.242370605469, -55.641002655029, 1003.546875, int= 6, dim = 1, items={"Telefono", "Agenda", "Lata de Spray", "Caja de Cigarros", "Encendedor", "Camara", "Cerveza", "Martillo", "Agua"}},
	{-23.242370605469, -55.641002655029, 1003.546875, int= 6, dim = 0, items={"Telefono", "Agenda", "Lata de Spray", "Caja de Cigarros", "Encendedor", "Camara", "Cerveza", "Martillo", "Agua"}},
	{-23.242370605469, -55.641002655029, 1003.546875, int= 6, dim = 9, items={"Telefono", "Agenda", "Lata de Spray", "Caja de Cigarros", "Encendedor", "Camara", "Cerveza", "Martillo", "Agua"}},
	--
	{-30.561338424683, -28.993001937866, 1003.5572509766, int= 4, dim = 0, items={"Lata de Spray", "Martillo", "Martillo", "Caja de Cigarros", "Encendedor", "Camara", "Cerveza", "Agua", "Bidon Vacio", "Caja de Herramientas"}},
	{-30.561338424683, -28.993001937866, 1003.5572509766, int= 4, dim = 1, items={"Lata de Spray", "Martillo", "Caja de Cigarros", "Encendedor", "Camara", "Cerveza", "Agua", "Bidon Vacio", "Caja de Herramientas"}},
	{-30.561338424683, -28.993001937866, 1003.5572509766, int= 4, dim = 5, items={"Lata de Spray", "Martillo", "Caja de Cigarros", "Encendedor", "Camara", "Cerveza", "Agua", "Bidon Vacio", "Caja de Herramientas"}},
	},
	["Bebidas"] = {
...
addEventHandler("BuyItem", root, function(item, costo)
	if source:getMoney() >= tonumber(costo) then -- or item == "Agenda" or item == "Cámara" or item == "Cuchillo de Caza (Arma)" or item == "Lata de Spray" or item == "Caja de Cigarros" or item == "Encendedor"
		...
		elseif item == "Camara" then
			...
			elseif item == "Martillo" then
				giveWeapon ( source, 12, 200 )
