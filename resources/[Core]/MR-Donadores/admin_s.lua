	...
	elseif ( action == "add" ) then
		if ( getAccount(vars[1]) ) then
			if ( not isPlayerVIP(vars[1]) ) then
				...
				if ( beneficier ) then
					exports.killmessages:outputMessage("* Ahora eres VIP "..vars[3].."!", beneficier, 0, 255, 150, "default")
					exports.killmessages:outputMessage("* Fecha de inicio: "..getDate("today"), beneficier, 0, 255, 150, "default")
					exports.killmessages:outputMessage("* Fecha de finalizacion: "..getDate(tonumber(vars[2])).." / Tiempo Dado: "..getTimeLeft(getDate("today"), getDate(tonumber(vars[2]))).." Dia(s)", beneficier, 0, 255, 150, "default")
